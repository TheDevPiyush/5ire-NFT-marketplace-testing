...
export default function IntegratedNFTPage() {
      ...
      <div className="w-full max-w-3xl bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        {/* <div className="mb-6">
          ...
          <div className="border-2 border-dashed border-gray-600 rounded-lg p-4 flex flex-col items-center">
            <input type="file" multiple onChange={handleFileChange} className="hidden" id="multi-file-input" />
            <label
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-400 mb-2">Upload Single File</label>
          <div className="border-2 border-dashed border-gray-600 rounded-lg p-4 flex flex-col items-center">
            <p className="text-gray-500 text-sm mb-2">PNG, GIF, WEBP, MP4, or MP3. Max 100mb.</p>
            <input type="file" onChange={handleSingleFileChange} className="hidden" id="single-file-input" />
            <label
